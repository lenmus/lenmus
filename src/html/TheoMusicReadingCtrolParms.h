...
#ifndef __LM_THEOMUSICREADINGCTROLPARAMS_H__        //to avoid nested includes
#define __LM_THEOMUSICREADINGCTROLPARAMS_H__
...
#endif  // __LM_THEOMUSICREADINGCTROLPARAMS_H__
