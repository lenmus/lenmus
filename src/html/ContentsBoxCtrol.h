...
class lmContentsBoxCtrol : public wxVScrolledWindow,
                            public wxHtmlWindowInterface,
                            public wxHtmlWindowMouseHelper
{
public:
    lmContentsBoxCtrol();
    lmContentsBoxCtrol(wxWindow *parent,
...
private:
    ...
    DECLARE_EVENT_TABLE()
    DECLARE_NO_COPY_CLASS(lmContentsBoxCtrol)
    DECLARE_ABSTRACT_CLASS(lmContentsBoxCtrol)
};

#endif // __LM_CONTENTSBOXCTROL_H__
