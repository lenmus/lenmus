...
#ifndef __LM_IDFYNOTESCTROLPARAMS_H__        //to avoid nested includes
#define __LM_IDFYNOTESCTROLPARAMS_H__
...
#include "../exercises/NotesConstrains.h"
...
class lmIdfyNotesCtrolParms : public lmExerciseParams
{
public:
    lmIdfyNotesCtrolParms(const wxHtmlTag& tag, int nWidth, int nHeight,
                              int nPercent, long nStyle);
    ~lmIdfyNotesCtrolParms();
...
protected:
    ...
    long                m_nWindowStyle;
    lmNotesConstrains*  m_pConstrains;

    DECLARE_NO_COPY_CLASS(lmIdfyNotesCtrolParms)
};



lmIdfyNotesCtrolParms::lmIdfyNotesCtrolParms(const wxHtmlTag& tag, int nWidth, int nHeight,
                                   int nPercent, long nStyle)
    : lmExerciseParams(tag, nWidth, nHeight, nPercent)
{
    ...
    m_pConstrains = new lmNotesConstrains(_T("IdfyNotes"));
...
lmIdfyNotesCtrolParms::~lmIdfyNotesCtrolParms()
{
...
void lmIdfyNotesCtrolParms::CreateHtmlCell(wxHtmlWinParser *pHtmlParser)
{
    ...
    if (m_sParamErrors != _T("")) {
        ...
        // create the IdfyNotesCtrol
        pWnd = new lmIdfyNotesCtrol((wxWindow*)pHtmlParser->GetWindowInterface()->GetHTMLWindow(), -1,
...
//wxString lmIdfyNotesCtrolParms::ParseAnswerButtons(wxString sParamValue, wxString sFullParam,
//                                                 bool* pfValidButtons)
//{
//    ////    cadence_buttons   list of answer buttons to display:
...
//wxString lmIdfyNotesCtrolParms::ParseCadences(wxString sParamValue, wxString sFullParam,
...
//}
//
//lmECadenceType lmIdfyNotesCtrolParms::CadenceNameToType(wxString sCadence)
//{
...
#endif  // __LM_IDFYNOTESCTROLPARAMS_H__
