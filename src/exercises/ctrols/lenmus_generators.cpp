...
//extern lmDPitch GetFirstLineDPitch(EClefType nClef);
...
//EClefType RandomGenerator::GenerateClef(lmClefConstrain* pValidClefs)
//{
...
//}
//
//EKeySignature RandomGenerator::GenerateKey(lmKeyConstrains* pValidKeys)
//{
...
//}
//
//lmETimeSignature RandomGenerator::GenerateTimeSign(lmTimeSignConstrains* pValidTimeSignatures)
//{
...
//}
//
//lmETimeSignature RandomGenerator::RandomTimeSignature()
//{
//    return (lmETimeSignature)RandomNumber(lmMIN_TIME_SIGN, lmMAX_TIME_SIGN);
//}
//
//lmDPitch RandomGenerator::GenerateRandomDPitch(int nMinLine, int nRange, bool fRests,
//                                     EClefType nClef)
//{
...
//}
//
//wxString RandomGenerator::GenerateRandomRootNote(EClefType nClef,
//                                                   EKeySignature nKey,
