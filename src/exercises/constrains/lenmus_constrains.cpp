...
//=======================================================================================
EBookCtrolOptions::EBookCtrolOptions(const string& sSection, ApplicationScope& appScope)
    : m_appScope(appScope)
...
//=======================================================================================
ExerciseOptions::ExerciseOptions(const string& sSection, ApplicationScope& appScope)
...
////-------------------------------------------------------------------------------------------
//
//ScoreCtrolOptions::ScoreCtrolOptions(wxString sSection)
//    : EBookCtrolOptions(sSection)
//{
//    //default values
//    fPlayCtrol = false;
//    fSolfaCtrol = false;
