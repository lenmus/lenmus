...
BEGIN_EVENT_TABLE(lmDlgCfgTheoIntervals, wxDialog)
    EVT_BUTTON(lmID_ACCEPT, lmDlgCfgTheoIntervals::OnAcceptClicked )
    EVT_BUTTON(lmID_CANCEL, lmDlgCfgTheoIntervals::OnCancelClicked )
    EVT_RADIOBOX(lmID_LEVEL, lmDlgCfgTheoIntervals::OnControlClicked )
    EVT_RADIOBOX(lmID_OTHER, lmDlgCfgTheoIntervals::OnControlClicked )
    EVT_CHECKBOX(lmID_CLEF, lmDlgCfgTheoIntervals::OnControlClicked )
    EVT_CHECKBOX(lmID_KEY, lmDlgCfgTheoIntervals::OnControlClicked )
    EVT_CHECKBOX(lmID_INTVAL_TYPE, lmDlgCfgTheoIntervals::OnControlClicked )
    EVT_COMBOBOX(lmID_LEDGER_ABOVE, lmDlgCfgTheoIntervals::OnControlClicked )
    EVT_COMBOBOX(lmID_LEDGER_BELOW, lmDlgCfgTheoIntervals::OnControlClicked )
...
void lmDlgCfgTheoIntervals::CreateControls()
{
	...
	m_pChkKeySign[earmDo] = new wxCheckBox( m_pPanelKeys, lmID_KEY, _("C Major / A minor"), wxDefaultPosition, wxDefaultSize, wxCHK_2STATE );

	bSizer7->Add( m_pChkKeySign[earmDo], 0, wxALIGN_LEFT|wxALL, 5 );

	m_pChkKeySign[earmSol] = new wxCheckBox( m_pPanelKeys, lmID_KEY, _("G Major / E minor"), wxDefaultPosition, wxDefaultSize, wxCHK_2STATE );

	bSizer7->Add( m_pChkKeySign[earmSol], 0, wxALIGN_LEFT|wxALL, 5 );

	m_pChkKeySign[earmRe] = new wxCheckBox( m_pPanelKeys, lmID_KEY, _("D Major / B minor"), wxDefaultPosition, wxDefaultSize, wxCHK_2STATE );

	bSizer7->Add( m_pChkKeySign[earmRe], 0, wxEXPAND|wxALL, 5 );

	m_pChkKeySign[earmLa] = new wxCheckBox( m_pPanelKeys, lmID_KEY, _("A Major / F# minor"), wxDefaultPosition, wxDefaultSize, wxCHK_2STATE );

	bSizer7->Add( m_pChkKeySign[earmLa], 0, wxEXPAND|wxALL, 5 );

	m_pChkKeySign[earmMi] = new wxCheckBox( m_pPanelKeys, lmID_KEY, _("E Major / C# minor"), wxDefaultPosition, wxDefaultSize, wxCHK_2STATE );

	bSizer7->Add( m_pChkKeySign[earmMi], 0, wxEXPAND|wxALL, 5 );

	m_pChkKeySign[earmSi] = new wxCheckBox( m_pPanelKeys, lmID_KEY, _("B Major / G# minor"), wxDefaultPosition, wxDefaultSize, wxCHK_2STATE );

	bSizer7->Add( m_pChkKeySign[earmSi], 0, wxEXPAND|wxALL, 5 );

	m_pChkKeySign[earmFas] = new wxCheckBox( m_pPanelKeys, lmID_KEY, _("F# Major / D# minor"), wxDefaultPosition, wxDefaultSize, wxCHK_2STATE );

	bSizer7->Add( m_pChkKeySign[earmFas], 0, wxEXPAND|wxALL, 5 );

	m_pChkKeySign[earmDos] = new wxCheckBox( m_pPanelKeys, lmID_KEY, _("C# Major / A# minor"), wxDefaultPosition, wxDefaultSize, wxCHK_2STATE );

	bSizer7->Add( m_pChkKeySign[earmDos], 0, wxEXPAND|wxALL, 5 );
	...
	m_pChkKeySign[earmDob] = new wxCheckBox( m_pPanelKeys, lmID_KEY, _("Cb Major / Ab minor"), wxDefaultPosition, wxDefaultSize, wxCHK_2STATE );

	bSizer8->Add( m_pChkKeySign[earmDob], 0, wxALIGN_LEFT|wxALL, 5 );

	m_pChkKeySign[earmSolb] = new wxCheckBox( m_pPanelKeys, lmID_KEY, _("Gb Major / Eb minor"), wxDefaultPosition, wxDefaultSize, wxCHK_2STATE );

	bSizer8->Add( m_pChkKeySign[earmSolb], 0, wxALIGN_LEFT|wxALL, 5 );

	m_pChkKeySign[earmReb] = new wxCheckBox( m_pPanelKeys, lmID_KEY, _("Db Major / Bb minor"), wxDefaultPosition, wxDefaultSize, wxCHK_2STATE );

	bSizer8->Add( m_pChkKeySign[earmReb], 0, wxEXPAND|wxALL, 5 );

	m_pChkKeySign[earmLab] = new wxCheckBox( m_pPanelKeys, lmID_KEY, _("Ab Major / F minor"), wxDefaultPosition, wxDefaultSize, wxCHK_2STATE );

	bSizer8->Add( m_pChkKeySign[earmLab], 0, wxEXPAND|wxALL, 5 );

	m_pChkKeySign[earmMib] = new wxCheckBox( m_pPanelKeys, lmID_KEY, _("Eb Major / C minor"), wxDefaultPosition, wxDefaultSize, wxCHK_2STATE );

	bSizer8->Add( m_pChkKeySign[earmMib], 0, wxEXPAND|wxALL, 5 );

	m_pChkKeySign[earmSib] = new wxCheckBox( m_pPanelKeys, lmID_KEY, _("Bb Major / G minor"), wxDefaultPosition, wxDefaultSize, wxCHK_2STATE );

	bSizer8->Add( m_pChkKeySign[earmSib], 0, wxEXPAND|wxALL, 5 );

	m_pChkKeySign[earmFa] = new wxCheckBox( m_pPanelKeys, lmID_KEY, _("F Major / D minor"), wxDefaultPosition, wxDefaultSize, wxCHK_2STATE );

	bSizer8->Add( m_pChkKeySign[earmFa], 0, wxEXPAND|wxALL, 5 );
