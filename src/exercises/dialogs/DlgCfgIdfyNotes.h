...
#ifndef __LM_DLGCFGIDFYNOTES_H__        //to avoid nested includes
#define __LM_DLGCFGIDFYNOTES_H__
...
{
public:
    lmDlgCfgIdfyNotes(wxWindow* parent, lmNotesConstrains* pConstrains);
...
protected:
    ...
    lmNotesConstrains*   m_pConstrains;      // the constraints to set up
...
#endif    // __LM_DLGCFGIDFYNOTES_H__
