...
BEGIN_EVENT_TABLE(lmDlgCfgIdfyTonality, wxDialog)
    EVT_BUTTON(wxID_OK, lmDlgCfgIdfyTonality::OnAcceptClicked )
    EVT_BUTTON(wxID_CANCEL, lmDlgCfgIdfyTonality::OnCancelClicked )
    EVT_BUTTON(lmID_BUTTON_ALL_MAJOR, lmDlgCfgIdfyTonality::OnCheckAllMajor )
    EVT_BUTTON(lmID_BUTTON_ALL_MINOR, lmDlgCfgIdfyTonality::OnCheckAllMinor )
    EVT_RADIOBOX(lmID_RAD_ANSWER_BUTTONS, lmDlgCfgIdfyTonality::OnDataChanged )
    EVT_CHECKBOX(lmID_CHECK_KEY, lmDlgCfgIdfyTonality::OnDataChanged )
END_EVENT_TABLE()
    ...
    , m_pConstrains(pConstrains)
{
    ...
    m_pChkKeySign[earmDo] = m_pChkKeyC;
    ...
    m_pChkKeySign[earmFa] = m_pChkKeyF;
        // Minor keys
...
lmDlgCfgIdfyTonality::~lmDlgCfgIdfyTonality()
{
}

void lmDlgCfgIdfyTonality::CreateControls()
{
...
void lmDlgCfgIdfyTonality::OnDataChanged(wxCommandEvent& WXUNUSED(event))
{
    VerifyData();
}

void lmDlgCfgIdfyTonality::OnAcceptClicked(wxCommandEvent& WXUNUSED(event))
{
...
bool lmDlgCfgIdfyTonality::VerifyData()
{
...
void lmDlgCfgIdfyTonality::OnCheckAllMajor(wxCommandEvent& WXUNUSED(event))
{
...
void lmDlgCfgIdfyTonality::OnCheckAllMinor(wxCommandEvent& WXUNUSED(event))
{
