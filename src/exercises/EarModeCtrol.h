...
//-------------------------------------------------------------------------------------
/*! @file EarModeCtrol.h
    @brief Header file for class lmEarModeCtrol
    @ingroup html_controls
*/

#ifndef __EARMODECTROL_H__        //to avoid nested includes
#define __EARMODECTROL_H__
...
class lmEarModeCtrol : public wxWindow    
{
   DECLARE_DYNAMIC_CLASS(lmEarModeCtrol)

public:

    // constructor and destructor    
    lmEarModeCtrol(wxWindow* parent, wxWindowID id,
