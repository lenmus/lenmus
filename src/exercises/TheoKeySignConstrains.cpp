// RCS-ID: $Id: TheoKeySignConstrains.cpp,v 1.4 2006/02/23 19:19:53 cecilios Exp $
//--------------------------------------------------------------------------------------
...
//
//-------------------------------------------------------------------------------------
/*! @file TheoKeySignConstrains.cpp
    @brief Implementation file for lmTheoKeySignConstrains class
    @ingroup generators
*/
...
lmTheoKeySignConstrains::lmTheoKeySignConstrains()
{
    //
    // default values
    //
