// RCS-ID: $Id: Formatter3.cpp,v 1.3 2006/02/23 19:23:54 cecilios Exp $
//--------------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------
/*! @file Formatter3.cpp
    @brief Implementation file for class lmFormatter3
    @ingroup score_kernel
*/
/*! @class lmFormatter3
    @ingroup score_kernel
    @brief A rendering algorithm based on a table of times and positions
*/
...
lmFormatter3::lmFormatter3() : lmFormatter()
{
    m_fDebugMode = false;
}

lmFormatter3::~lmFormatter3()
{
    //wxLogMessage(_T("[lmFormatter3::~lmFormatter3] Deleting lmFormatter3 object"));
...
//void lmFormatter3::SetScore(oScore As CScore)
//    Set m_pScore = oScore
//    m_nIdLastCanvas = 0
...
void lmFormatter3::RenderJustified(lmPaper* pPaper)
{
...
//    while (oTI.QuedanItems
//        Set pSO = oTI.GetItem
//        pSO->Dibujate fModoMedida, m_oCanvas
//        if (fModoMedida And pSO->GetType() = eTPO_NoteRest) { pPaper->GetCursorX() = pPaper->GetCursorX() + 1.5 * dyLinea
//        oTI.AdvanceCursor
//    }
//
//}

void lmFormatter3::DrawMeasure(lmVStaff* pVStaff, int nMeasure, lmPaper* pPaper)
{
    /*
    ...
    */
    ...
    /*! @todo
        ...
        code in lmFormatter3::SizeMeasure
    */
