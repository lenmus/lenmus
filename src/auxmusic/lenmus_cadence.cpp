...
//}
//
//bool lmCadence::Create(lmECadenceType nCadenceType, EKeySignature nKey, bool fUseGrandStaff)
//{
...
//    //get chords
//    wxString sFunct;
//	m_nImperfectCad = RandomGenerator::RandomNumber(0, 3);	//to select an imperfect authentic cadence
//    int iC;
...
//        int iSel = RandomGenerator::RandomNumber(1, nValidFirst);
//        int nValid = 0;
//        int iC;
...
//
//
//wxString lmCadence::SelectChord(wxString sFunction, EKeySignature nKey, int* pInversion)
//{
...
//}
//
//wxString lmCadence::GetRootNote(wxString sFunct, EKeySignature nKey, lmEClefType nClef,
//                                bool fUseGrandStaff)
//{
...
//    DiatonicPitch nMinAltoPitch = DPitch(lmSTEP_G, 3);
//    DiatonicPitch nMaxAltoPitch = DPitch(lmSTEP_D, 5);
//    DiatonicPitch nMinTenorPitch = DPitch(lmSTEP_D, 3);
//    DiatonicPitch nMaxTenorPitch = DPitch(lmSTEP_G, 4);
//
//
...
//        DiatonicPitch nAltoPitch = DPitch(oChordNotes[iA].nStep, 3);
...
//        DiatonicPitch nTenorPitch = DPitch(oChordNotes[iT].nStep, 3);
...
//    else                            // else
//        oChordNotes[iB].nOctave = 3;      //  place note in octave 3
//    DiatonicPitch nBassPitch = DPitch(oChordNotes[iB].nStep, oChordNotes[iB].nOctave);
...
//    DiatonicPitch nMaxPitch = DPitch(lmSTEP_C, 6);
//    int iN;             // point to note in process
//    for (iN=0; iN < nNumNotes; iN++) {
//        DiatonicPitch nDPitch = DPitch(oChordNotes[iN].nStep, 2);
...
//
//
//int lmCadence::GenerateSopranoNote(NoteBits oChordNotes[4], int iBass,
//                                          int nNumNotes)
//{
