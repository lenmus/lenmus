...
//{
//    int         nNumNotes;
//    FIntval   nIntervals[lmINTERVALS_IN_CHORD];   //from root note
//}
//lmChordData;
//
...
//}
//
//lmChord::lmChord(wxString sRootNote, lmFiguredBass* pFigBass, EKeySignature nKey)
//    : lmChordIntervals(0, (FIntval*)NULL)
//    , m_nKey(nKey)
//    , m_nInversion(0)
...
//}
//
//lmChord::lmChord(int nNumNotes, wxString* pNotes, EKeySignature nKey)
...
//}
//
//lmChord::lmChord(wxString sRootNote, wxString sIntervals, EKeySignature nKey)
...
//lmChord::lmChord(int nStep, EKeySignature nKey, int nIntervals, int nInversion, int octave)
...
//lmChord::lmChord(int nNumNotes, lmNote** pNotes, EKeySignature nKey)
//    : lmChordIntervals(nNumNotes, pNotes)
//    , m_nKey(nKey)
...
//
//// Creates a chord from a list of score notes
//lmChord::lmChord(int nNumNotes, lmFPitch fNotes[], EKeySignature nKey)
...
//}
//
//FIntval lmChord::GetInterval(int i)
//{
...
//}
//
//MidiPitch lmChord::GetMidiNote(int i)
//{
...
////----------------------------------------------------------------------------------------
//
//lmChordIntervals::lmChordIntervals(int nNumIntv, FIntval* pFI)
//    : m_nNumIntv(nNumIntv)
//{
...
//}
//
//lmChordIntervals::lmChordIntervals(int nRootStep, EKeySignature nKey, int nNumIntervals, int nInversion)
//{
...
//
//    FIntval nNewIntervals[lmINTERVALS_IN_CHORD];
