...
//
//*/
//lmScore* Composer::GenerateScore(lmScoreConstrains* pConstrains)
//{
//    //Save parameters
...
//
//
//int Composer::GetRootStep(const EKeySignature nKey) const
//{
...
//}
//
//void Composer::AddSegment(wxString* pMeasure, lmSegmentEntry* pSegment, float rNoteTime)
//{
...
//
//    // step 2
//    g_pLogger->LogTrace(_T("Composer"), _T("[AddSegment] Adding segment %s, duration=%.2f"),
...
//}
//
//wxString Composer::CreateLastMeasure(int nNumMeasure, lmETimeSignature nTimeSign,
...
////----------------------------------------------------------------------------------
//
//bool Composer::InstantiateNotes(lmScore* pScore, EKeySignature nKey)
//{
...
//    DiatonicPitch dnMinPitch = m_nMinPitch.ToDPitch();
//    DiatonicPitch dnMaxPitch = m_nMaxPitch.ToDPitch();
...
//}
//
//void Composer::InstantiateNotesRandom(lmScore* pScore)
//{
//    // Loop to process notes/rests in first staff of first instrument
//    lmInstrument* pInstr = pScore->GetFirstInstrument();
//    lmVStaff* pVStaff = pInstr->GetVStaff();
...
//
//    return lmAPitch((DiatonicPitch)nNewPitch, 0);
//}
//
...
//    int iP = RandomGenerator::RandomNumber(0, nNumProgs-1);
//    for(int i=0; i < 8; i++)
//    {
...
//}
//
//lmAPitch Composer::MoveByStep(bool fUpStep, lmAPitch nPitch, lmAPitch aScale[7])
//{
...
//}
//
//lmAPitch Composer::MoveByChromaticStep(bool fUpStep, lmAPitch nPitch)
//{
...
//}
//
//void Composer::GenerateScale(EKeySignature nKey, lmAPitch aNotes[7])
//{
//    int nAcc[7];
//    lmComputeAccidentals(nKey, nAcc);
//    int nStep = GetRootStep(nKey);
...
//}
//
//lmAPitch Composer::GenerateInChordList(EKeySignature nKey, long nChord,
...
//    DiatonicPitch dnMinRoot = DPitch(nRootStep, nOctave);
//
...
//        int nShift = RandomGenerator::RandomNumber(0, nRange-2);
//        dnMinRoot += 7*nShift;
...
//        nCurve = RandomGenerator::RandomNumber(0, lmSTART_RESTRICTED_CONTOURS-1);
...
//        nCurve = RandomGenerator::RandomNumber(0, lmMAX_CONTOUR-1);
//        fUp = RandomGenerator::FlipCoin();
//    }
//
...
//
//
//lmAPitch Composer::NearestNoteOnChord(DiatonicPitch nPoint, lmNote* pNotePrev,
//                                            lmNote* pNoteCur,
//                                            std::vector<lmAPitch>& aOnChordPitch)
//{
...
//        g_pLogger->LogTrace(_T("Composer::NearestNoteOnChord"), _T("Previous note = %s"), (pNotePrev->GetAPitch()).LDPName().c_str());
//        return pNotePrev->GetAPitch();
//    }
//
//    for (int i=0; i < (int)aOnChordPitch.size(); i++) {
//        DiatonicPitch dnCur = aOnChordPitch[i].ToDPitch();
//        if (nPoint == dnCur)
...
//            DiatonicPitch dnPrev = aOnChordPitch[i-1].ToDPitch();
...
//}
//
//void Composer::InstantiateWithNote(lmScore* pScore, lmAPitch anPitch)
//{
...
//
//
//void Composer::AssignNonChordNotes(int nNumNotes, lmNote* pOnChord1, lmNote* pOnChord2,
...
//}
//
//void Composer::NeightboringNotes(int nNumNotes, lmNote* pOnChord1, lmNote* pOnChord2,
//                                    lmNote* pNonChord[], lmAPitch aScale[7])
//{
//    // Receives the two on-chord notes and the non-chord notes between them, and assign
...
//
//    bool fUpStep = RandomGenerator::FlipCoin();
...
//}
//
//void Composer::PassingNotes(bool fUp, int nNumNotes, lmNote* pOnChord1, lmNote* pOnChord2,
//                               lmNote* pNonChord[], lmAPitch aScale[7])
//{
//    // Receives the two on-chord notes and the non-chord notes between them, and assign
//    // the pitch to all notes. The number of non-chord notes received is in 'nNumNotes'
...
//}
//
//void Composer::ThirdFifthNotes(bool fUp, int nNumNotes, lmNote* pOnChord1, lmNote* pOnChord2,
//                               lmNote* pNonChord[], lmAPitch aScale[7])
//{
//    // Receives the two on-chord notes and the non-chord notes between them, and assign
//    // the pitch to all notes. The number of non-chord notes received is in 'nNumNotes'
