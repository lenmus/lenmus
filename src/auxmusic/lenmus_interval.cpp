...
//#pragma implementation "lenmus_interval.h"
//#endif
//
...
//
////=======================================================================================
//// Implementation of Interval class
////=======================================================================================
//
//
////Generate a random interval satisfying the received constraints.
//Interval::Interval(bool fDiatonic, int ntDiatMin, int ntDiatMax, bool fAllowedIntervals[],
//             bool fAscending, EKeySignature nKey, int nMidiStartNote)
//{
//    if (!m_fStringsInitialized) FIntval_InitializeStrings();
//
//    //dbg------------------------------------------------------
//    g_pLogger->LogTrace(_T("Interval"), _T("Direction = %s, type = %s\n"),
...
//    g_pLogger->LogTrace(_T("Interval"), _T("MidiMin=%d, MidiMax=%d\n"),
//                        ntMidiMin, ntMidiMax);
//
...
//    int ntAux2;
//    int nNumValidNotes;
//    RandomGenerator oGen;     //random generator
//    while (nNumIntv != 0)
//    {
//        //dbg -----------------------------------------------
...
//        g_pLogger->LogTrace(_T("Interval"), _T("Intv iSel: isel= %d, Intv= %d\n"),
//                            iSel, nSelIntv);
//
...
//            fComply = false;
//            if (fDiatonic) {
//                if (MPitch_IsNaturalNote((MidiPitch)ntAux, m_nKey)) {
//                    ntAux2 = (fAscending ? ntAux + nSelIntv : ntAux - nSelIntv);
//                    if (MPitch_IsNaturalNote((MidiPitch)ntAux2, m_nKey)) fComply = true;
//                }
//            } else {
...
//    //    _T("[Interval::Analyze]: Diat1=%d, Diat2=%d, MIDI1=%d, MIDI2=%d, ")
...
//
//}
//wxString Interval::GetIntervalCode()
//{
//    lmIntvBits tIntv;
...
//}
//
//void Interval::GetNoteBits(int i, NoteBits* pBits)
//{
//    wxASSERT(i==0 || i==1);
//
...
//}
//
//FIntval FIntval(wxString& sName)
//{
//    // unison
...
//}
//
//FIntval FIntval_FromType(int nIntv, lmEIntervalType nType)
//{
//    for (int i=0; i < 40; i++)
//    {
...
//}
//
//int FIntval_GetNumber(FIntval fi)
//{
...
//}
//
//wxString FIntval_GetIntvCode(FIntval fi)
//{
...
//}
//
//wxString FIntval_GetName(FIntval fi)
//{
...
//}
//
//lmEIntervalType FIntval_GetType(FIntval fi)
//{
//    fi %= 40;   //Now fi= 0..39
