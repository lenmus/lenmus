// RCS-ID: $Id: ArtProvider.h,v 1.2 2006/02/23 19:15:54 cecilios Exp $
//--------------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------
/*! @file ArtProvider.h
    @brief Header file for class lmArtProvider
    @ingroup app_gui
*/
#ifndef __ARTPROVIDER_H__        //to avoid nested includes
#define __ARTPROVIDER_H__

// GCC interface
#if defined(__GNUG__) && !defined(__APPLE__)
    #pragma interface "ArtProvider.h"
#endif
