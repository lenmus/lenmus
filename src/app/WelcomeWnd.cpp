...
void lmWelcomeWnd::CreateControls()
{
	...
	m_pBmpLogo = new wxStaticBitmap( this, wxID_ANY, wxNullBitmap, wxDefaultPosition, wxSize( 70,50 ), 0 );
	pHeadersSizer->Add( m_pBmpLogo, 0, wxALL, 5 );
	...
	m_pTxtTitle->Wrap( -1 );
	m_pTxtTitle->SetFont( wxFont( 14, 74, 90, 92, false, wxT("Tahoma") ) );
	...
	pMainSizer->Add( pHeadersSizer, 0, wxEXPAND|wxTOP|wxRIGHT|wxLEFT, 20 );
	...
	pContentSizer->Add( pItemsSizer, 0, wxEXPAND, 5 );
