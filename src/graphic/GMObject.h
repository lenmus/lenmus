...
public:
    ...
    inline bool IsHandler() const { return m_nType == eGMO_Handler; }
        ...
        //shape level
    lmEShapeLevel GetShapeLevel() { return m_nShapeLevel; }
    void SetShapeLevel(lmEShapeLevel nShapeLevel) { m_nShapeLevel = nShapeLevel; }
    bool IsMainShape() { return m_nShapeLevel == lm_eMainShape; }
    bool IsSecondaryShape() { return m_nShapeLevel == lm_eSecondaryShape; }
    bool IsPrologShape() { return m_nShapeLevel == lm_ePrologShape; }
...
protected:
    ...
    lmEShapeLevel   m_nShapeLevel;  //shape level: main, secondary or prolog
