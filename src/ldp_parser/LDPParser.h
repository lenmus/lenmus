...
//#if lmUSE_LIBRARY
    //New: "Parse" methods work on source text
    lmScore*    ParseFile(const std::string& filename, bool fErrorMsg = true);
    lmLDPNode*  ParseText(const std::string& sSource);
    lmScore*    ParseScoreFromText(const std::string& sSource, bool fErrorMsg = true);
//#endif
