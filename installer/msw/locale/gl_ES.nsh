...
LangString SM_PRODUCT_GROUP             ${LANG_Galician} "${APP_NAME}"
LangString SHORTCUT_NAME_EXEC           ${LANG_Galician} "Executar ${APP_NAME}"
LangString SHORTCUT_NAME_UNINSTALL      ${LANG_Galician} "Desinstalar ${APP_NAME}"

;other strings
LangString OTHER_LangName             ${LANG_Galician} "gl_ES"

;End Galician language file
;=========================================================================================
