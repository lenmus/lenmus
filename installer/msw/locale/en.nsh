...
LangString TITLE_CreateIcon     ${LANG_English} "Shortcut on desktop"
...
LangString DESC_CreateIcon      ${LANG_English} "Create a shortcut icon on the desktop"
...
LangString MSG_ABORT                ${LANG_English} "Installation cancelled"
...
LangString SHORTCUT_NAME_UNINSTALL      ${LANG_English} "Un-install ${APP_NAME}"
