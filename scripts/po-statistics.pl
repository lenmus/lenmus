#!/usr/bin/perl
##------------------------------------------------------------------------------------
## Copyright (C) 2009 LenMus proyect
##
...
##------------------------------------------------------------------------------------
    ...
    %ebooks = (
        ...
        "intro" => "eBook: LenMus introduction",
        ...
        "EditorQuickGuide" => "Document: Editor Quick Guide",
    );
...
sub WriteTranslation
{
    ...
    printf ($html_file "<tr><td class='book'><img src='modules/paginas/images/1ptrans.gif' width='41px' height='2px'>$ebook_name</td>\n");
    ...
    if ($translated > 0.5)
    {
        printf ($html_file "<img src='modules/paginas/images/bar_green.gif' height='15' width='%.0f'>", $translated);
    }
    if ($fuzzy > 0.5)
    {
        printf ($html_file "<img src='modules/paginas/images/bar_yellow.gif' height='15' width='%.0f'>", $fuzzy);
    }
    if ($untranslated > 0.5)
    {
        printf ($html_file "<img src='modules/paginas/images/bar_red.gif' height='15' width='%.0f'>\n", $untranslated);
    }
...
sub StartLanguage
{
    ...
    print $html_file "<tr>
<td class='langname'>$langname [$lang]</td><td class='center'><a href='###translation_credits####'><img src='modules/paginas/images/$icon' /> <b>$status</b></a></td><td>&nbsp;</td></tr>\n";
...
<p>
<b>Legend for graphs:</b>&nbsp;&nbsp;&nbsp; <img src='modules/paginas/images/bar_green.gif' alt='translated' title='translated' width='32' height='15'/> Translated&nbsp;&nbsp;&nbsp;
<img src='modules/paginas/images/bar_yellow.gif' alt='fuzzy' title='fuzzy' width='32' height='15'/> Fuzzy&nbsp;&nbsp;&nbsp;
<img src='modules/paginas/images/bar_red.gif' alt='untranslated' title='untranslated' width='32' height='15' /> Untranslated
</p>

<p>The translations status is as follows:</p>
<ul>
  <li><img src='modules/paginas/images/ok.png' /> <b>maintained</b></span> -
  translator(s) sends updates when requested.</li>
  <li><img src='modules/paginas/images/question.jpg' /> <b>unknown</b></span> - I did not received translation updates and I don't know if the translator(s) is (are) still interested.</li>
  <li><img src='modules/paginas/images/error.jpg' /> <b>unmaintained</b></span> - I haven't heard anything from the translator(s) for two program releases or the translator explicitly informed he/she will not continue to maintain the translation.</li>
</ul>
...
<tr><td colspan='3' height='8px'><img src='modules/paginas/images/RayaAzul.gif' width='500px' height='16px'></td></tr>
\n\n");
...
print $html_file "<tr><td colspan='3' height='8px'><img src='modules/paginas/images/RayaAzul.gif' width='500px' height='16px'></td></tr>
