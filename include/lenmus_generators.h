...
//
//    // key signature
//    static EKeySignature GenerateKey(lmKeyConstrains* pValidKeys);
...
//    static wxString GenerateRandomRootNote(EClefType nClef, EKeySignature nKey, bool fAllowAccidentals);
...
//{
//public:
//    lmQuestion(long nSpaceID, long nSetID, long nParam0 = 0L, long nParam1 = 0L,
...
//    static bool LoadQuestions(long nSetID, lmProblemSpace* pPS);
//
...
//    lmQuestion* AddQuestion(long nParam0 = 0L, long nParam1 = 0L, long nParam2 = 0L,
//                            long nParam3 = 0L, long nParam4 = 0L,
//                            int nGroup = 0, int nAskedTotal = 0, int nSuccessTotal = 0,
//                            int nRepetitions = 0,
//                            wxTimeSpan tsLastAsked = wxTimeSpan::Days(-36500),      //never asked (100 years)
