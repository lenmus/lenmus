...
//    ~lmCadence();
//
//    bool Create(lmECadenceType nCadenceType, EKeySignature nKey, bool fUseGrandStaff);
...
//    wxString GetRootNote(wxString sFunct, EKeySignature nKey, lmEClefType nClef,
//                         bool fUseGrandStaff);
//
