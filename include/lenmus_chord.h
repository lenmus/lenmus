...
//{
//public:
//    lmChordIntervals(int nNumIntv, FIntval* pFI);
...
//    lmChordIntervals(int nNumNotes, lmFPitch fNotes[], int nUseless); // int nUseless: just to distinguish from  constructor (int nNumIntv, FIntval*)
//    lmChordIntervals(int nNumNotes, lmNote** pNotes);
//    lmChordIntervals(int nStep, EKeySignature nKey, int nNumIntervals, int nInversion);
//
//    ~lmChordIntervals();
//
//    //accessors
...
//
//protected:
//    FIntval       m_nIntervals[lmINTERVALS_IN_CHORD];
//    int             m_nNumIntv;
//};
//
//
...
//    lmChord(wxString sRootNote, lmFiguredBass* pFigBass, EKeySignature nKey = k_key_C);
...
//    lmChord(int nNumNotes, lmNote** pNotes, EKeySignature nKey = k_key_C);
//    lmChord(int nNumNotes, lmFPitch fNotes[], EKeySignature nKey);
//        //build a chord from a list of intervals (as strings)
//    lmChord(wxString sRootNote, wxString sIntervals, EKeySignature nKey);
//        // build a chord from "essential" information
//    lmChord(int nDegree, EKeySignature nKey, int nNumIntervals, int nNumInversions, int octave);
//
//    //destructor
//    virtual ~lmChord();
//
...
//    MidiPitch GetMidiNote(int i);    //0..n-1
